...
var parameters = {};		// Data to be sent 
var zone_start = [];		// Start zone
var zone_end = [];			// Destination zone
...
function initMap() {
	...
	map = new google.maps.Map(document.getElementById('map'), {	// Generate map
		center: {lat: 40.6735, lng: -73.9700},
		zoom: 11
	});
	var starting_point = {lat: 40.6735, lng: -73.9700};			// Set initial center
	var ending_point = {lat: 40.6735, lng: -73.9700};
	var start_marker;
	var end_marker;

	google.maps.event.addListener(map, 'click', function(event) {	// Set marker once click
		center = event.latLng;
